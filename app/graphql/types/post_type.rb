...
module Types
  class PostType < Types::BaseObject
    ...
    field :order, Integer,
          description: 'Order in which to show posts belonging to a parent. Lowest number appears first.'
    field :parent,
          PostType,
          null: true,
          description: 'The post under which this post will appear. Null if this is a top-level post.'
    ...
    field :summary, String, description: "Summary to appear on card at the bottom of the parent's page"
